...
import { ArrowLeft, Pencil, Image as ImageIcon, LayoutTemplate, Eye } from "lucide-react"; // Import LayoutTemplate and Eye icons
import { useProductById } from "@/hooks/use-products.js";
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          <Button asChild variant="outline">
            <Link to={`/products/${product.id}/landing-page-view`}> {/* New button for viewing */}
              <Eye className="h-4 w-4 mr-2" />
              View Landing Page
            </Link>
          </Button>
          <Button asChild variant="outline">
            <Link to={`/products/${product.id}/landing-page-settings`}> {/* Existing button for settings */}
          ...
          <Card>
            ...
            <CardContent className="grid gap-2">
              ...
              <div>
                ...
                <p className="text-base">{product.brand_id || "N/A"}</p>
              </div>
              <div>
