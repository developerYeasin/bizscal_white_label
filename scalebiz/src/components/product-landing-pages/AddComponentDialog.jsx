...
const AddComponentDialog = ({ onAddComponent, isUpdating }) => {
    ...
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      ...
      <DialogContent className="sm:max-w-[425px] p-0">
        <DialogHeader className="p-6 pb-0">
          ...
          <DialogDescription>Select a component to add to your landing page.</DialogDescription>
        </DialogHeader>
        <ScrollArea className="max-h-[400px] w-full p-6">
