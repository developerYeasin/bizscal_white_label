...
import StickyHeader from "../PremiumTheme/StickyHeader";
...
const DiamondHeader = ({
  ...
  useEffect(() => {
    ...
    return () => {
      window.removeEventListener("change", toggleVisibility);
    };
  }, [toggleVisibility]);
      ...
      <header className="bg-background text-foreground">
        ...
        <div className="bg-white border-b border-gray-200 py-2 px-6 hidden md:block text-sm text-gray-800">
          <div className="container mx-auto flex items-center justify-between">
            ...
            {/* Currency and Language Switchers for Top Bar */}
            <div className="flex items-center space-x-4">
        ...
        <div className="sticky top-0 z-40 bg-background border-b border-border">
          <div className="container mx-auto flex justify-between items-center py-4 px-6">
            <Link to={getPath("/")} className="flex items-center flex-shrink-0">
              {headerLogoUrl ? (
                <img
                  src={headerLogoUrl}
                  alt={storeName}
                  className="h-7 md:h-8 lg:h-10 mr-2"
                />
              ) : (
            ...
            <div className="flex items-center space-x-1 md:space-x-4 flex-shrink-0 ml-auto lg:ml-0">
              <Button
                variant="ghost"
                size="icon"
                className="flex"
              ...
              {/* Removed Currency and Language Switchers from here as they are now in the top bar */}
            </div>
          </div>
        </div>
            ...
            >
              <PopoverTrigger asChild>
                <Button
                  ...
                  variant="ghost"
                  className="flex items-center gap-2 text-foreground p-3 font-semibold text-lg -ml-6 pr-6 hover:text-dynamic-primary-color cursor-pointer"
                >
