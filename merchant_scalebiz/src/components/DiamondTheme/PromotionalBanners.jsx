...
const PromotionalBanners = ({ data, className }) => {
  ...
  return (
    <section className={cn("py-8 md:py-12 px-0 sm:px-6 bg-background", className)}>
              ...
              >
                ...
                {banner.ctaButton && (
                  <Link to={banner.ctaButton.link}>
                    <ThemedButton variant="secondary" className=" rounded-none hover:bg-primary hover:text-primary-foreground duration-300 transition-all ease-in-out ">
