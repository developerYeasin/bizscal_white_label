-- =================================================================
-- Complete ScaleBiz Database Schema
-- =================================================================
-- This schema includes all tables needed for the platform
-- =================================================================
...
-- =================================================================
-- Table: theme_blocks (Defines available blocks for each theme)
-- =================================================================
...
CREATE TABLE IF NOT EXISTS `stores` (
  ...
  `contact_email` varchar(255) CHARACTER SET utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `store_theme_settings` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_store_id` (`store_id`),
  CONSTRAINT `fk_sts_store_id` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_sts_theme_id` FOREIGN KEY (`theme_id`) REFERENCES `themes` (`id`) ON DELETE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- =================================================================
-- Table: pages (custom pages built with page builder)
-- =================================================================
...
-- =================================================================
-- Additional tables (orders, coupons, etc.) would go here
-- For brevity, focusing on essential tables for page builder
-- =================================================================
