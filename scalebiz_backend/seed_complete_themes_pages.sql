-- =================================================================
-- Complete SQL Script for Akira, Axon, and Ghorer Bazar Themes
-- =================================================================
-- This script creates all necessary themes, theme blocks, and pages
-- for the Akira, Axon, and Ghorer Bazar e-commerce themes
-- =================================================================
...
(1, 'Home', 'home', '{
  "blocks": [
    ...
    {"id": "heroBannerWithProduct", "type": "heroBannerWithProduct", "data": {"title": "আফ্রিকার ওয়াইল্ড অর্গানিক খাবার", "subtitle": "এখন বাংলাদেশে", "imageUrl": "https://via.placeholder.com/1200x500?text=African+Wild+Organic+Food", "phone": "09642922922", "backgroundColor": "#FF9F1C", "textColor": "#FFFFFF"}},
    ...
    {"id": "featuresTrustBadges", "type": "featuresTrustBadges", "data": {"badges": [{"icon": "🌿", "title": "Organic Products", "subtitle": "100% organic and natural"}, {"icon": "🚚", "title": "Free Shipping", "subtitle": "On orders over 1000 BDT"}, {"icon": "💯", "title": "Quality Guarantee", "subtitle": "Quality assured products"}, {"icon": "💬", "title": "Customer Support", "subtitle": "24/7 support"}]}},
